...
// Empiezo el pdf
// Declaro variables
$title1 = 'Tutoría de '.$asignacion->listaDeAsignaciones['cursosAfectados'][$clave].' - Fotografías';
$title2= 'Lista de clase con Fotos. Ordenados por Apellidos.';
...
$alumnadoArray=explode("#",$alumnado); // devuelve un array con los números de alumnos...
  ...
  foreach ($alumnadoArray as $clave => $i) {
	  ...
	  $html.='
	  <tr>
	  <td style="width: 10%;"><img style="width: 50px; height: auto;"src="../.'.$alumno->esteAlumno["foto"].'"></td>
	  <td style="width: 48%;"><p style="font-size: 15px; font-weight: bold;">'.$alumno->esteAlumno["nombre2"].'</p></td>
