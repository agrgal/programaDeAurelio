...
<head profile="http://www.w3.org/2005/10/profile">
  ...
  <title>Histórico de opiniones</title>
  <link rel="icon" 
        type="image/png" 
...
<!-- *************************** -->
  ...
  <script>     
     ...
     $("#listaFechas")
			.selectmenu({
				...
				select: function( event, ui ) {	
					...
					$('#todosNinguno').jqxSwitchButton('uncheck'); // Por defecto, están todos sin seleccionar
			    },
			 })
		...
		$("#dialog-confirm-borrar").dialog({
					buttons : {
						...
						$("#panel1").find(".eleccion").each(function() {
						   ...
						   if (Si==1) {
						   ...
						   } // Fin del IF de si está escogido		
							...
							$.when.apply(this, results).done(function () {
								...
								$.each(arguments,function(index,value){ // los datos de retorno quedan establecidos en arguments...
									// alert(value); // Si hay más de dos valores, value es un array con {data, success, jqxhr }
									...
									$("#lista2").append(datos.notificacion2+'<hr width="80%" align="center">');
										...
										try { // Si da un error, intenta hacerlo con value directamente. Si es JSON funcionará ¿¿??
    ...
    // C) Datepicker fecha
     $("#fecha2").button({ width: '20px' }); // Así lo reconoce como del tema sunny 		 
	 $("#fecha2").datepicker({  			 
			   dateFormat: 'dd-mm-yy',
...
// * ================================================================================================ */	 
	 ...
	 $(document).on('click','.eleccion',function(event){
		 ...
		 var idTabla = $(this).parent().parent().parent().parent().attr("id"); // alcanzo el nivel de tabla
		 var eleccion = $(this).parent().parent().parent().parent().attr("elegir"); // Si está elegido o no...
...
// * ================================================================================================ */	 	 
	 ...
	 // ************************************
	 // F2) Establece variable de sesión de idalumno
